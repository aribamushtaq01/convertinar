      ...
      >
        ...
        <div className="order-1 md:order-2 text-center flex flex-col items-center">
          ...
          >
            ...
            <button className="w-full md:hidden flex items-center justify-center bg-white text-[#111827] px-8 py-3.5 rounded-full text-[0.9rem] font-medium border border-black/10 gap-2.5 transition-all duration-300 hover:-translate-y-1.5 hover:bg-[#fdfdfd] hover:border-black/20 hover:shadow-[0_15px_35px_rgba(0,0,0,0.08)] cursor-pointer">
